...
//        messageLabel.setTranslatesAutoresizingMaskIntoConstraints(false)
    ...
    func configureWithMessage(message: ChatMessage) {
...
func bubbleImageMake() -> (incoming: UIImage, incomingHighlighed: UIImage, outgoing: UIImage, outgoingHighlighed: UIImage) {
    ...
    let outgoing = coloredImage(maskIncoming,  red: 0.05 ,green: 0.47,blue: 0.91,alpha: 1.0).resizableImageWithCapInsets(capInsetsOutgoing)
    let outgoingHighlighted = coloredImage(maskIncoming, red: 32/255, green: 96/255, blue: 200/255, alpha: 1).resizableImageWithCapInsets(capInsetsOutgoing)
