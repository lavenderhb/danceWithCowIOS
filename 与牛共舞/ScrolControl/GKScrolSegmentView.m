...
@interface GKScrolSegmentView () <UIScrollViewDelegate>
/* 文字scrollView */
...
@implementation GKScrolSegmentView
...
//        
//    }else if(i == 3){
//        self.titleScrollView.contentOffset = CGPointMake(kScreenWidth/3, 0);
//        
//    }else{
//        self.titleScrollView.contentOffset = CGPointMake(0, 0);
//        
