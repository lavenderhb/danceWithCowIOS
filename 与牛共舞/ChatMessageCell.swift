...
protocol ChatMessageCellDelegate:NSObjectProtocol {
    func selectHeadView(model:ChatMessageModel)
    
    //  picture
    func tapPicture(messageModel:ChatMessageModel, tableViewCell:UITableViewCell)
...
@objc(ChatMessageCell)
class ChatMessageCell: UITableViewCell {
    
    internal var headImageView:UIImageView!
    internal var messageBubble:ChatMessageBubble?
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        self.messageBubble = ChatMessageBubble(frame: CGRectZero)
    ...
    func setCellData(model:ChatMessageModel, delegate:JChatMessageCellDelegate) {
