...
class EvEdayWEbView: UIViewController {
...
//        headerView.backgroundColor = UIColor.blackColor()
        ...
        let HEadLabel = UILabel(frame: CGRectMake(self.headerView.bounds.width / 2 - 40, 25, 80, 30))
        ...
        let SearchBuuton = UIButton(frame: CGRectMake(self.headerView.bounds.width - 40, 25, 30, 30))
        ...
        Backbutton = UIButton(frame: CGRectMake(0, 25, 30, 30))
