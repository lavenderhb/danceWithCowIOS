...
class HardWEbViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.navigationItem.title = "理财团队"
        ...
        LastButton.frame = CGRectMake(20, KScreenHeight - 100, KScreenWidth - 40, 40)
        ...
        LastButton.addTarget(self, action: #selector(HardWEbViewController.LastAction), forControlEvents: UIControlEvents.TouchUpInside)
        ...
        backbb.addTarget(self, action: #selector(HardWEbViewController.backToPrevious), forControlEvents: UIControlEvents.TouchUpInside)
