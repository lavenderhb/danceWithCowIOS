...
class ENDdddweb: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        LastButton.addTarget(self, action: #selector(ENDdddweb.LastAction), forControlEvents: UIControlEvents.TouchUpInside)
        ...
        backbb.addTarget(self, action: #selector(ENDdddweb.backToPrevious), forControlEvents: UIControlEvents.TouchUpInside)
