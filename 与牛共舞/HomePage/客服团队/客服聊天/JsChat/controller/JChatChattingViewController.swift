...
class JChatChattingViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if ((pushJudge.objectForKey("push")?.isEqualToString("push")) != nil){
            ...
            let nac = UIBarButtonItem.init(image: UIImage(named: "22.jpg"), style: UIBarButtonItemStyle.Plain, target: self, action: #selector(JChatChattingViewController.rebackToRootViewAction))
