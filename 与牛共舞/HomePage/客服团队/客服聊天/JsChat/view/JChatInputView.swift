...
//        self.moreView.backgroundColor = UIColor.blueColor()
...
//        let uittt  = UIButton()
//        uittt.backgroundColor = UIColor.blackColor()
//        
//        self.inputWrapView.addSubview(uittt)
//        uittt.snp_makeConstraints { (make) in
//            make.edges.equalTo(self.inputWrapView).inset(UIEdgeInsets(top: 1, left: 1 , bottom: 2, right: 250))
//        }
//        
...
//        let uqq = UIButton()
//        uqq.backgroundColor = UIColor.blackColor()
//        inputWrapView.addSubview(uqq)
//        uqq.snp_makeConstraints { (make) in
////            make.top.equalTo(inputWrapView).offset(2)  self.inputWrapView.bounds.width / 6 * 5
////            make.bottom.equalTo(inputWrapView).offset(2)
//           
//            make.edges.equalTo(inputWrapView).inset(UIEdgeInsets(top: 2, left: 2, bottom: 2, right: 350))
//        }
//        
...
//        inputWrapView  背景的视图
        self.inputWrapView.addSubview(self.switchBtn)
...
//            
//            make.left.equalTo(inputWrapView).offset(2)
...
//            make.size.equalTo(CGSize(width: 27, height: 27))
        ...
        self.showMoreBtn.setBackgroundImage(UIImage(named: "add01_pre"), forState: .Normal)
...
//            make.bottom.equalTo(inputWrapView).offset(-4)
//            make.size.equalTo(CGSize(width: 27, height: 27))
            make.edges.equalTo(inputWrapView).inset(UIEdgeInsets(top: 5, left: 0, bottom: 5, right: 5))
        })
...
//            make.left.equalTo(self.switchBtn.snp_right).offset(5)
        ...
        self.recordVoiceBtn.snp_makeConstraints { (make) -> Void in
            make.right.equalTo(self.showMoreBtn.snp_left).offset(-5)
            make.left.equalTo(self.switchBtn.snp_right).offset(0)
